...
function calculate() {
    if (value !== "" && value > 0 && unit !== "") {
        ...
        document.getElementById("outputkg").innerHTML = "Kilograms: " + convertToKg(value, unit);
        document.getElementById("outputg").innerHTML = "Grams: " + convertToG(value, unit);
        document.getElementById("outputlb").innerHTML = "Pounds: " + convertToLb(value, unit);
        document.getElementById("outputoz").innerHTML = "Ounces: " + convertToOz(value, unit);
    } else {
        conversionOutputs.style.visibility = 'hidden';
    }
}
